...
class TransportManager
{
    ...
    public function for(string $type): NotificationTransport { return match ($type) { 'sms_gateway' => $this->sms, 'generic_webhook' => $this->webhook, default => throw new InvalidArgumentException("Unsupported destination type: $type") }; }
}
