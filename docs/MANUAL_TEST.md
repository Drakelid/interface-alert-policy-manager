...
31. Restore the physical interface and verify exactly one real recovery SMS.
32. Disable the former direct LibreNMS SMS operation and confirm IAPM is the only live sender.
