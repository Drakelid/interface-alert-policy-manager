...
<div class="iapm-form-footer">
    ...
    <span class="iapm-hint">SMS delivery is capped at one carrier segment; long rendered messages are truncated without adding fields that are not in your template.</span>
</div>
</form>
</div>@endsection
