...
@include('iapm::partials.step-header',['step'=>3,'total'=>3,'title'=>'Map interfaces to policies','desc'=>'An assignment maps interfaces to a policy. More specific types win (port &gt; port-group &gt; device &gt; device-group &gt; location &gt; regex &gt; type &gt; default). Add a <strong>default</strong> assignment so nothing is left uncovered. Then finish with the Setup Helper to point LibreNMS at IAPM.','prevRoute'=>route('iapm.policies.index'),'prevLabel'=>'Policies','nextRoute'=>route('iapm.setup-helper'),'nextLabel'=>'Setup Helper'])
