...
<thead><tr><th style="width:2em;"><input type="checkbox" aria-label="Select all assignments on this page" onclick="document.querySelectorAll('.iapm-bulk').forEach(e=>e.checked=this.checked)"></th><th>Policy</th><th>Type</th><th>Reference / expression</th><th>Mode</th><th>Priority</th><th>Status</th><th></th></tr></thead>
